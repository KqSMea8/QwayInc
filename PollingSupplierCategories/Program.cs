...
namespace PollingSupplierCategories
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            BusinessLogic.PollingSupplierCategories(System.Configuration.ConfigurationManager.ConnectionStrings["Alibaba"].ConnectionString);
