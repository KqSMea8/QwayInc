...
namespace PollSupplierFromBusinessCard
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            BusinessLogic.PollingSuppliersFromCusinessCard(System.Configuration.ConfigurationManager.ConnectionStrings["Alibaba"].ConnectionString);
