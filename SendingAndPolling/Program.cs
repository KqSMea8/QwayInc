...
namespace SendingAndPolling
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            //BusinessLogic.Test();
#if DEBUG
            //BusinessLogic.getUrlXPaths();
            args = new string[] { "5","0" };
#endif
            BusinessLogic.SendingAndPolling(System.Configuration.ConfigurationManager.ConnectionStrings["Alibaba"].ConnectionString, args);
